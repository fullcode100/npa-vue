		...
		<main class="article">
			<div class="article__header">
				<div class="fit-article">
					...
					<p class="article__summary">
					Voter pour une liste anticapitaliste et révolutionnaire c'est <span class="bold">faire entendre la voix de celles et ceux qui luttent</span>. C'est <span class="bold">faire entendre les préoccupations et les intérêts de celles et ceux que l'on n'écoute jamais</span>: les pauvres, les oppriméEs, les exploitéEs.
					</p>
				</div>
			</div>
			<div class="fit-article article__content">
				...
				<p>
					<span class="bold">Nantes est une ville riche, mais elle est aussi inégalitaire</span>. A Nantes comme ailleurs les licenciements ne sont pas rares et l'<span class="bold">on manque d'argent et de personnel dans tous les services publics</span>. Comme au CHU, qui est en saturation par manque de moyens, à quoi s'ajoute le projet inutile de son déplacement. 
				</p> 
				<p>
					Ce ne sont pourtant pas les moyens financiers qui manquent. <span class="bold">Les grandes entreprises françaises du CAC40 affichent des gains époustouflants et en hausse</span> : ils ont distribué 60 milliards à leurs actionnaires en 2019, alors que, avec cette somme, on pourrait créer plus d'un million et demi d'emplois ! De quoi résoudre une grande partie des problèmes des hôpitaux et des écoles !
				</p> 
				<p>
					Macron, lui, a préféré arroser les patrons et les riches de cadeaux fiscaux, dont la suppression de l'impôt sur la fortune. Et <span class="bold">les grandes villes comme Nantes sont d'énormes gâteaux financiers</span>, dont les budgets arrosent les sociétés de BTP, d'autoroutes, en laissant des miettes pour le « social ».

					<a href="https://npa-nantes-2020.org/articles/nos-positions/la-couleur-jaune-du-fric/" style="color:red" style="font-weight:bold">Voir notre article sur le projet YelloPark</a>
				</p>

				<a class="anchor" id="programme-lutter"></a>
				<h3>Un programme pour lutter</h3>
				<p>
					Certains appellent à voter tout sauf Macron et ses relais locaux. D'autres à voter Macron pour éviter Le Pen. Comme si l'on devait choisir entre un banquier avec des idées racistes et une raciste amie des banquiers ! D'autres encore prétendent pouvoir résoudre localement les tares de cette société. Pourtant, qu'on le veuille ou non, <span class="bold">les problèmes locaux, nationaux et internationaux sont mêlés.</span>
				</p> 
				<p>
					Voter, surtout aux élections municipales, ne réglera pas les problème du chômage, des salaires en berne, du manque de logements, de la misère des hôpitaux et des écoles, de l'oppression des femmes, du racisme... <span class="bold">Loin des promesses électorales, la véritable opposition à Macron ce sont les travailleuses et les travailleurs en lutte, et démocratiquement organisés pour la défense de revendications urgentes et vitales.</span> 
				</p> 
				<p>
				...
				<ul class="list">
					...
					<li>
						<span class="bold">Plafonnement des loyers et réquisition des logements vides.</span> Les loyers à Nantes sont devenus hors de portée, et pas seulement dans le centre-ville. L'accès à la propriété est presque impossible. Que va-t-il se passer ? <span class="bold">Nous ne pourrons plus payer les loyers, et nous devrons refuser de les payer.</span> Faire cesser la spéculation immobilière et l'exode des plus modestes hors de la ville, nécessitera l'organisation des locataires pour imposer des loyers décents par une lutte massive. Il faut <span class="bold">utiliser les terrains vacants pour construire des logements sociaux et les services qui vont avec</span>, privilégier la réhabilitation de ce qui peut l'être et arrêter les démolitions. <a href="https://npa-nantes-2020.org/articles/nos-positions/contre-le-mal-logement/" style="color:red" style="font-weight:bold">Voir notre article sur le mal-logement à Nantes</a> ; <a href="https://npa-nantes-2020.org/articles/nos-positions/renovation-urbaine-2-2-des-politiques-non-pas-sociales-mais-securitaires/" style="color:red" style="font-weight:bold">Voir notre article sur les politiques sécuritaires de rénovation urbaine</a> ; <a href="https://npa-nantes-2020.org/articles/nos-positions/renovation-urbaine-1-2-malakoff-la-mixite-sociale-a-la-nantaise/" style="color:red" style="font-weight:bold">Voir notre article sur la politique de rénovation urbaine à Malakoff</a>
					</li>
					<li>
				...
				<p>
					Dans ces élections municipales, la liste présentée par le NPA veut <span class="bold">porter toutes les exigences issues des luttes, locales et nationales</span> : celles des cheminotEs et de l'ensemble du monde du travail contre la réforme des retraites, celles des personnels des universités contre la précarité, des enseignants et des élèves des lycées contre le bac Blanquer et le tri social à l'école, celles des hospitaliers pour les salaires et des embauches.
				</p> 
				<p>
					<span class="bold">Notre liste est à l'image de la majorité des habitantes et des habitants de cette ville</span>. Elle compte des salariés, des travailleurs en galère et en situation précaire, des étudiantEs, des retraitéEs. Elle compte des hommes et des femmes de tous âges qui ont participé à l'organisation des grèves et des mobilisations dans leurs secteurs, et qui ont à cœur les intérêts de leur classe sociale.
				</p> 
				<p>
					Nos élus au conseil municipal s'engagent à y <span class="bold">défendre les intérêts des travailleuses et des travailleurs de la ville et de ses quartiers populaires</span>. ils se serviront de tous les moyens à leur disposition pour être les relais des luttes et aider à leur organisation et à leur victoire.
				</p> 
				...
				<p>
					...
					pas des professionnels de la politique : ils et elles sont salarié·es ou au chômage. Tous les jours, et
					pas seulement pendant les élections, nous luttons avec nos collègues, voisins <span class="bold">contre
					la misère et cette société violente et injuste.</span> 
				</p>
				<p>
